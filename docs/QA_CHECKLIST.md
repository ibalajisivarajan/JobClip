...
- [ ] No scraping proxies or external scraping APIs are used.
...
- [ ] Dashboard navigation shows Dashboard, Jobs, Add Job, and Settings.
- [ ] `/dashboard/jobs/new` opens for signed-in users.
- [ ] Paste Job URL mode fetches details only after the user clicks **Fetch Details**.
- [ ] Paste Job Description mode parses text and shows an editable preview.
- [ ] Paste URL + Job Description mode prefers description content and stores URL metadata.
- [ ] All preview fields are editable before save.
- [ ] Save inserts `user_id`, `captured_at`, and `capture_method`.
- [ ] Saved manual URL jobs appear in the Vercel dashboard.
- [ ] Saved manual text jobs appear in the Vercel dashboard.
...
- [ ] Add Job by URL saves a job to Supabase.
- [ ] Add Job by description saves a job to Supabase.
